    ...
    children: [
      {
        label: "About",
        description:
          "Learn how you can use Volleyscope to it's full potential to optimise your team's progress!",
        icon: "ix:about",
        to: "/",
      },
      {
      ...
      },
      {
        label: "Leaderboards",
        description:
          "View your Player's Performance Statistics from the most recent data",
      ...
      },
      {
        label: "Data Analysis",
        description:
          "Analyse your recorded data through intuitive graphing and filtering!",
    ...
    children: [
      {
        label: "Player List",
        description:
          "View all the player's registered with the organisation and their information and stats",
