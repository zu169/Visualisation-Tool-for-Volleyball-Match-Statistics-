...
const sections = [
  { name: "Match Info", visible: true },
  { name: "Timeline View", visible: true },
  { name: "Player List", visible: true },
  { name: "Match Stats", visible: true },
];
</script>
    ...
    <div class="flex justify-between items-center">
      ...
      <div>
        <UButton
          ...
          color="success"
          variant="soft"
          :to="{ path: '/matchInput', query: { match: matchId } }"
          >Edit Match</UButton
        >
        <UButton
          type="submit"
      ...
      <template #footer>
        <div class="flex justify-between p-2">
          <div v-if="sections[2].visible === true" class="w-[35%]">
            <p>Player List</p>
            <MatchSetPlayerTable :match-id="8" :set-id="1" />
          </div>
